...
class NetworkTrainer:
    ...
    def call_unet(self, args, accelerator, unet, noisy_latents, timesteps, text_conds, batch, weight_dtype, encoder_hidden_states, down_block_additional_residuals, mid_block_additional_residual):
    ...
    def sample_images(self, accelerator, args, epoch, global_step, device, vae, tokenizer, text_encoder, unet, controlnet=None):
        train_util.sample_images(accelerator, args, epoch, global_step, device, vae, tokenizer, text_encoder, unet, controlnet=controlnet)
    ...
    def train(self, args):
        ...
        accelerator.print("-----------------Controlnet Load하는 부분-------------------------------")
        ...
        # NOTE: (hyejin) transform DDP after prepare
        ...
        # For --sample_at_first
        self.sample_images(accelerator, args, 0, global_step, accelerator.device, vae, tokenizer, text_encoder, unet, controlnet=None)
        ...
        for epoch in range(num_train_epochs):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                with accelerator.accumulate(network):
                    ...
                    # TODO (hyejin): conditioning image dataloader에 추가
                    ...
                    with accelerator.autocast():
                        ...
                        #     noisy_latents,
                        #     timesteps,
                        #     encoder_hidden_states=text_encoder_conds,
                ...
                if accelerator.sync_gradients:
                    ...
                    self.sample_images(accelerator, args, None, global_step, accelerator.device, vae, tokenizer, text_encoder, unet, controlnet)
            ...
            self.sample_images(accelerator, args, epoch + 1, global_step, accelerator.device, vae, tokenizer, text_encoder, unet, controlnet=None)
